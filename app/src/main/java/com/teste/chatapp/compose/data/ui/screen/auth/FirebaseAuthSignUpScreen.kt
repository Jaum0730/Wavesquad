package com.teste.chatapp.compose.data.ui.screen.auth
...
import com.teste.chatapp.compose.data.ui.navigation.FirebaseAuthNavRoute
import com.teste.chatapp.compose.data.ui.state.FirebaseLoginState
import com.teste.chatapp.compose.data.ui.viewmodel.FirebaseAuthViewModel
    ...
    Column(
        ...
        Button(onClick = {
            if (inputEmail.isNotEmpty() && inputPassword.isNotEmpty())
                viewModel.signUpAuthUser(inputEmail, inputPassword)
        }) {
        ...
        Spacer(modifier = Modifier.padding(10.dp))
        Button(onClick = { navController.navigate(FirebaseAuthNavRoute.AuthSignIn.route) }) {
            Text(text = "Sign in")
        }
    }
}